            ...
            <table id="infoBar">
                <tr>
                    <td>                        
                        ...
                        Belépve mint: <b><a href="about.jsp">${family.student.firstName} ${family.student.lastName} családja</a></b>                        
                    </td>
                    <td>
            ...
            <div id="header">
                <div class="content">    
                    <ul>
                        ...
                        <li class="headerLi"><a href="grades.jsp">Jegyei</a></li>                                               
                        <li class="headerLi"><a href="reportAttendance.jsp">Hiányzás bejelentése</a></li>                                               
            ...
            <div id="subHeader">
                <div class="content">
                    ...
                    <ul class="subHeaderUl" style="display: none;">
                        <li><a href="">Jelszóváltoztatás</a></li>
                    </ul>                    
                </div>
            </div>
